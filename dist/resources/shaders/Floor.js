...
void main() {
    ...
    vec4 v_Position4 = modelMatrix *  vec4(position, 1.0);
...
// referenced https://subscription.packtpub.com/book/game-development/9781789342253/9/ch09lvl1sec85/creating-a-wood-grain-effect
...
void main(void){
    ...
    //vec3 colorA = vec3(0.95, 0.7, 0.5);
    vec3 colorA = vec3(0.28, 0.16, 0.0);
    vec3 colorB = vec3(0.12, 0.08, 0.0);

    // tile them
    vec2 st = vUv;

    vec4 slice = u_Slice * vec4(st, 0, 1.0);

    //vec2 sl = rotate2d( fbm(slice) ) * slice.xy;
    ...
    vec3 color = mix(colorB, colorA, rings);
